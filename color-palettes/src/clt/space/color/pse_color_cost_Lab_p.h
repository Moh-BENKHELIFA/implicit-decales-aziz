#ifndef PSE_COLOR_COST_LAB_P_H
#define PSE_COLOR_COST_LAB_P_H
...
enum pse_color_cost_func_ctxt_LAB_id_t {
...
#undef PSE_COLOR_COST_FUNC
  ...
  PSE_COLOR_COST_FUNC_CTXT_LAB_UID_COUNT
};
